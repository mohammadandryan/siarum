    ...
    <div class="container mt-3">
        ...
        <div class="row mt-4 justify-content-center">
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-4 justify-content-center">
                <a href="{{ route('page.soon') }}" class="tnone text-dark">
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-4 justify-content-center">
                <a href="{{ route('kegiatans.index') }}" class="tnone text-dark">
                    <div class="card" style="margin:auto;max-width: 100%;">
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-4 justify-content-center">
                <a href="{{ route('page.soon') }}" class="tnone text-dark">
                    <div class="card" style="margin:auto;max-width: 100%;">
                        <img src="{{ asset('img/data.jpg') }}" class="card-img-top" alt="Event">
                        <div class="card-body text-center">
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-4 justify-content-center">
                <a href="{{ route('page.soon') }}" class="tnone text-dark">
                    <div class="card" style="margin:auto;max-width: 100%;">
                        ...
                        <div class="card-body text-center">
                            <h5 class="card-title">PRTA Zone</h5>
                        </div>
                    </div>
                </a>
            </div>
